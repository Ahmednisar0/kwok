...
// 🍗 Chicken Items
{ id: 60, name: 'Schezwan Chicken', price: 999, description: 'Spicy and flavorful Schezwan-style chicken', images: ['/chicken/1.jpg'], category: 'Chicken Items' },
{ id: 61, name: 'Kampyo Chicken', price: 999, description: 'House special Kampyo-style chicken', images: ['/chicken/2.jpg'], category: 'Chicken Items' },
{ id: 62, name: 'Korean Chicken', price: 999, description: 'Authentic Korean-style chicken', images: ['/chicken/3.jpg'], category: 'Chicken Items' },
{ id: 63, name: 'Crispy Honey Crunch Chicken', price: 999, description: 'Crispy chicken coated in sweet honey sauce', images: ['/chicken/4.jpg'], category: 'Chicken Items' },
{ id: 64, name: 'Sweet & Sour Chicken', price: 999, description: 'Classic sweet and sour flavored chicken', images: ['/chicken/5.jpg'], category: 'Chicken Items' },
{ id: 65, name: 'Chicken Manchurian', price: 999, description: 'Chinese-style chicken in Manchurian sauce', images: ['/chicken/6.jpg'], category: 'Chicken Items' },
{ id: 66, name: 'Chicken Shashlik', price: 999, description: 'Grilled chicken skewers served with sauce', images: ['/chicken/7.jpg'], category: 'Chicken Items' },
{ id: 67, name: 'Chicken Chili Dry', price: 999, description: 'Spicy dry chicken with chili flavor', images: ['/chicken/8.jpg'], category: 'Chicken Items' },
{ id: 68, name: 'KK Special Chicken', price: 999, description: 'Signature house special chicken', images: ['/chicken/9.jpg'], category: 'Chicken Items' },
{ id: 69, name: 'Thai Sweet Chili Chicken', price: 999, description: 'Chicken tossed in Thai sweet chili sauce', images: ['/chicken/10.jpg'], category: 'Chicken Items' },
{ id: 70, name: 'Hot Garlic Chicken', price: 999, description: 'Spicy hot garlic flavored chicken', images: ['/chicken/11.jpg'], category: 'Chicken Items' },
{ id: 71, name: 'Chicken in Black Pepper Sauce', price: 999, description: 'Chicken cooked in rich black pepper sauce', images: ['/chicken/12.jpg'], category: 'Chicken Items' },
// 🥩 Beef Items
